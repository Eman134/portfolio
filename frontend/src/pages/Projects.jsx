...
const Projects = () => {
    ...
    const smallProjectsData = [
        ...
        },
        {
            ...
            github: null,
            demo: 'https://youtu.be/FEVy1iBxfVw'
        },
        {
            techs: ['Java'],
            ...
            github: null,
            demo: 'https://www.youtube.com/watch?v=52SXmRmHhhk'
        },
        {
            techs: ['Unity', 'C#'],
            ...
            github: null,
            demo: 'https://youtu.be/eP6TXsJXxaA'
        },
        {
            techs: ['Discord.js', 'Node.js'],
            titleKey: 'smallprojects.project-6-title',
            descKey: 'smallprojects.project-6-description',
            github: null,
            demo: 'https://youtu.be/AcFOHO7P_c4'
        },
        {
            techs: ['Skript'],
            titleKey: 'smallprojects.project-7-title',
            descKey: 'smallprojects.project-7-description',
            github: null,
            demo: 'https://www.youtube.com/watch?v=iYm9dCmbGcM'
        },
        {
            techs: ['Wired Logic'],
            titleKey: 'smallprojects.project-8-title',
            descKey: 'smallprojects.project-8-description',
            github: null,
            demo: null
        },
        {
            techs: ['AdonisJS', 'Node.js'],
            titleKey: 'smallprojects.project-9-title',
            descKey: 'smallprojects.project-9-description',
            github: 'https://github.com/Eman134/emanblog',
            demo: null
        }
    ];
                        ...
                        <div className="project-body-premium">
                            ...
                            <div className="project-btns-premium" onClick={(e) => e.stopPropagation()}>
                                {project.githubPrivate ? (
                                    ...
                                    project.github && <a href={project.github} target="_blank" rel="noopener noreferrer" className="btn-card-sm">&gt; GitHub</a>
                                )}
                                ...
                                {project.demo && (
                                    <a href={project.demo} target="_blank" rel="noopener noreferrer" className="btn-card-sm">&gt; Demo</a>
                                )}
                            </div>
                        </div>
                    </div>
